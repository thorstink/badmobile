...
// This file contains a bunch of pure functions needed to make the vehicel do
// what you want
...
std::pair<double, double> 2DTwistToAngularWheelSpeed(double v, double omega) {
  double omegaLeft = (v - omega * (vehicel_parameters.track / 2.0)) /
                     vehicel_parameters.radius;
  double omegaRight = (v + omega * (vehicel_parameters.track / 2.0)) /
                      vehicel_parameters.radius;
